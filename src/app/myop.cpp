...
int main() {
  ...
  cout << "rotulação do tops refatorado" << endl;
  for (auto symbol : labeling.label()) {
    std::cout << symbol;
  }
  std::cout << std::endl << std::endl;

  cout << "rotulação do tops-viterbi_decondig" << endl;
  cout << "1100000000000000011111111111000000000000000000000000000000000000011111111111110000000000000000000000" << endl;
