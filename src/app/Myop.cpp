...
Myop::Myop(std::string dataset) {
  ...
  // Start
  auto start = tops::app::make_state_start();

  // Exons
  auto ES = tops::app::make_state_ES();

  auto EI0 = tops::app::make_state_EI0();
  auto EI1 = tops::app::make_state_EI1();
  auto EI2 = tops::app::make_state_EI2();

  auto E00 = tops::app::make_state_E00();
  auto E01 = tops::app::make_state_E01();
  auto E02 = tops::app::make_state_E02();

  auto E10 = tops::app::make_state_E10();
  auto E11 = tops::app::make_state_E11();
  auto E12 = tops::app::make_state_E12();

  auto E20 = tops::app::make_state_E20();
  auto E21 = tops::app::make_state_E21();
  auto E22 = tops::app::make_state_E22();

  auto ET0 = tops::app::make_state_ET0();
  auto ET1 = tops::app::make_state_ET1();
  auto ET2 = tops::app::make_state_ET2();

  // Donors
  auto don0 = tops::app::make_state_don0();
  auto don1 = tops::app::make_state_don1();
  auto don2 = tops::app::make_state_don2();

  // Introns
  auto I0 = tops::app::make_state_I0();
  auto I1 = tops::app::make_state_I1();
  auto I2 = tops::app::make_state_I2();

  auto Is0 = tops::app::make_state_Is0();
  auto Is1 = tops::app::make_state_Is1();
  auto Is2 = tops::app::make_state_Is2();

  auto If0 = tops::app::make_state_If0();
  auto If1 = tops::app::make_state_If1();
  auto If2 = tops::app::make_state_If2();

  // Acceptors
  auto acc0 = tops::app::make_state_acc0();
  auto acc1 = tops::app::make_state_acc1();
  auto acc2 = tops::app::make_state_acc2();

  // Stop
  auto stop = tops::app::make_state_stop();
  ...
  // Stop
  auto rstop = tops::app::make_state_rstop();

  // Exons
  auto rES = tops::app::make_state_rES();

  auto rEI0 = tops::app::make_state_rEI0();
  auto rEI1 = tops::app::make_state_rEI0();
  auto rEI2 = tops::app::make_state_rEI0();

  auto rE00 = tops::app::make_state_rE00();
  auto rE01 = tops::app::make_state_rE01();
  auto rE02 = tops::app::make_state_rE02();

  auto rE10 = tops::app::make_state_rE10();
  auto rE11 = tops::app::make_state_rE11();
  auto rE12 = tops::app::make_state_rE12();

  auto rE20 = tops::app::make_state_rE20();
  auto rE21 = tops::app::make_state_rE21();
  auto rE22 = tops::app::make_state_rE22();

  auto rET0 = tops::app::make_state_rET0();
  auto rET1 = tops::app::make_state_rET1();
  auto rET2 = tops::app::make_state_rET2();

  // Acceptors
  auto racc0 = tops::app::make_state_racc0();
  auto racc1 = tops::app::make_state_racc1();
  auto racc2 = tops::app::make_state_racc2();

  // Introns
  auto rI0 = tops::app::make_state_rI0();
  auto rI1 = tops::app::make_state_rI1();
  auto rI2 = tops::app::make_state_rI2();

  auto rIs0 = tops::app::make_state_rIs0();
  auto rIs1 = tops::app::make_state_rIs1();
  auto rIs2 = tops::app::make_state_rIs2();

  auto rIf0 = tops::app::make_state_rIf0();
  auto rIf1 = tops::app::make_state_rIf1();
  auto rIf2 = tops::app::make_state_rIf2();

  // Donors
  auto rdon0 = tops::app::make_state_rdon0();
  auto rdon1 = tops::app::make_state_rdon1();
  auto rdon2 = tops::app::make_state_rdon2();
